(function(window){
    ...
    var Seed = function(tree, point, scale, color) {
        ...
        var seedScale = scale || 1;
        var seedColor = color || '#FFC0CB';
    ...
    Tree.prototype = {
        ...
        move: function(k, x, y) {
            ...
            try {
                ...
                console.warn('Could not put image data:', e);
            }
            ctx.restore();
    ...
    // Make sure objects are properly exported to window
